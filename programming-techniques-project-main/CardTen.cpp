...
bool CardTen::Cardbought = false;
Player* CardTen::Owner = false;
bool CardTen::CardInitialized = NULL;
...
void CardTen::SetCardbought(bool S)
{
	Cardbought = S;
}
...
int CardTen::GetCellPrice()
{
	return CardPrice;
}

Card* CardTen::Clone(CellPosition newPosition)
{
	Card* newCard = new CardTen(newPosition);
	return newCard;
}
