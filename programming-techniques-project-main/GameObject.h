...
public:
	...
	virtual bool AreOverlapping(GameObject* Obj) const ; // OD not pure virtual we don't need it in Card Class         
	//Check overlapping                                                    // For example, applying a ladder is by moving player up, and so on
